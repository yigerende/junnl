    ...
    <>
      ...
      <div className="grid gap-4 grid-cols-2 md:grid-cols-5 mb-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-red-500">{disabledCredentialCount}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-500">
                {data?.credentials.filter(c => c.failureCount > 0).length || 0}
              </div>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-orange-500">
                {data?.credentials.filter(c => c.refreshFailureCount > 0).length || 0}
              </div>
            </CardContent>
          </Card>
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-blue-500">
                {(data?.credentials.reduce((sum, c) => sum + c.successCount, 0) || 0).toLocaleString()}
              </div>
            </CardContent>
          </Card>
          <Card>
